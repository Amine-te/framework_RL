...
def run_comparison(episodes=5000, grid_size=7):
    ...
    plt.tight_layout()
    plt.savefig('plots/function_approximation_with_goal_improved.png', dpi=300, bbox_inches='tight')
    print("Saved: plots/function_approximation_with_goal_improved.png")
    plt.show()
