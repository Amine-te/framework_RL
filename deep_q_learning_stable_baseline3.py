...
from deep_q_learning_moving_goal import get_random_goal
...
def plot_fixed_goal(callback_fixed):
    ...
    plt.tight_layout()
    plt.savefig('plots/sb3_dqn_fixed_goal.png', dpi=300, bbox_inches='tight')
    print("\nSaved: plots/sb3_dqn_fixed_goal.png")
    plt.close()
...
def plot_moving_goal_comparison(callback_relative, callback_absolute):
    ...
    plt.tight_layout()
    plt.savefig('plots/sb3_dqn_moving_goal_comparison.png', dpi=300, bbox_inches='tight')
    print("\nSaved: plots/sb3_dqn_moving_goal_comparison.png")
    plt.close()
