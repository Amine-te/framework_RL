...
from scripts.agents.q_learning import QLearningAgent
...
def run_parameter_study(episodes=2000):
    ...
    # Create base filename prefix with episodes
    base_prefix = f'q_learning_ep{episodes}'
    ...
    for alpha in alphas:
        ...
        agent.save(str(agents_dir / f'{base_prefix}_alpha{alpha}_gamma0.9_grid7.pkl'))
    ...
    for gamma in gammas:
        ...
        agent.save(str(agents_dir / f'{base_prefix}_alpha0.1_gamma{gamma}_grid7.pkl'))
    ...
    for size in grid_sizes:
        ...
        agent.save(str(agents_dir / f'{base_prefix}_alpha0.1_gamma0.9_grid{size}.pkl'))
        env.close()
    ...
    plt.tight_layout()
    plot_filename = f'{base_prefix}_alpha_comparison_grid7.png'
    plt.savefig(str(plots_dir / plot_filename), dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    plot_filename = f'{base_prefix}_gamma_comparison_grid7.png'
    plt.savefig(str(plots_dir / plot_filename), dpi=300, bbox_inches='tight')
    print(f"Saved: {plots_dir / plot_filename}")
    plt.close()
    ...
    plt.tight_layout()
    plot_filename = f'{base_prefix}_grid_size_comparison.png'
    plt.savefig(str(plots_dir / plot_filename), dpi=300, bbox_inches='tight')
    print(f"Saved: {plots_dir / plot_filename}")
    plt.close()
    ...
    print(f"All trained agents saved to '{agents_dir}' directory")
